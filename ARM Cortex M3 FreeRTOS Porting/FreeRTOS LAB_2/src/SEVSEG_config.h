...
#define 	SEVSEG1_PINA			PORTA,PIN0
#define 	SEVSEG1_PINB			PORTA,PIN1
#define 	SEVSEG1_PINC			PORTA,PIN2
#define 	SEVSEG1_PIND 			PORTA,PIN3
#define 	SEVSEG1_PINE			PORTA,PIN4
#define 	SEVSEG1_PINF			PORTA,PIN5
#define 	SEVSEG1_PING			PORTA,PIN6
